...
function removeUpload(state: UploadState = INITIAL_STATE, action: RemoveUploadAction): UploadState {
...
function setUploadError(state: UploadState = INITIAL_STATE, action: SetUploadErrorAction): UploadState {
    //indexUpload, indexFile
    const videoId = action.payload.video.id;
    const fileField = action.payload.fileField;
    const {indexUpload, indexFile} = findIndexUploadAndFile(state, videoId, fileField);
...
function findIndexUploadAndFile(state: UploadState, videoId, fileField): { indexUpload?, indexFile? } {
